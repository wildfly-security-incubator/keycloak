 ...
 * the License.
 */
package org.keycloak.subsystem.elytron.extension;

import org.keycloak.elytron.subsystem.extension.KeycloakElytronExtension;
...
public class SubsystemParsingTestCase extends AbstractSubsystemBaseTest {
    ...
    public SubsystemParsingTestCase() {
        super(KeycloakElytronExtension.SUBSYSTEM_NAME, new KeycloakElytronExtension());
    }
 ...
 /*   @Test
    ...
    protected String getSubsystemXml() throws IOException {
        return readResource("keycloak-elytron-1.0.xml");
    }

    @Override
    protected String getSubsystemXsdPath() throws Exception {
        return "schema/keycloak-elytron_1_0.xsd";
    }

    @Override
    protected String[] getSubsystemTemplatePaths() throws IOException {
        return new String[]{
            "/subsystem-templates/keycloak-elytron.xml"
        };
    }
}
